...
import getRelatedPDEElec from '@salesforce/apex/AP011_ShowRelatedPDEController.getRelatedPDEElec';

export default class Lwcc020_ShowRelatedPDEElec extends LightningElement {
    @api recordId;
    selectedPDEId;
    relatedPDE = [];
    numberOfelement = '';
    ...
    columns = [
        ...
        {label: "Numéro PDE",fieldName: "ReferencePointEnergie_Refonte__c",sortable: "true"},
    ...
    connectedCallback(){
        ...
        .then((data) => {
            ...
            data.forEach((PDE) => {
                ...
                tempRec.ReferencePointEnergie_Refonte__c = PDE.ReferencePointEnergie_Refonte__c;
    ...
    downloadCSVElec(){
        window.open('https://alliancedesenergies.my.site.com/partenaire/resource/Templates/Template_Import/Template_IMPORT_PDE_ELEC.xlsx');        
